...
const PLANNED = [
  { label: 'Client Onboarding Forms', desc: 'Intake questionnaires and PAR-Q forms for new clients.' },
  { label: 'Progress Tracking Templates', desc: 'Structured check-in forms and measurement trackers.' },
  { label: 'Consultation Templates', desc: 'Goal-setting and initial consultation frameworks.' },
  { label: 'Business Guides', desc: 'Pricing, packages, and business setup guidance for PTs.' },
]
...
export default function BusinessToolsScreen() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
      <Header title="Business Tools" onBack={() => navigate(-1)} />
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '40px 20px 48px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: '36px' }}>
          <div style={{
            ...
            <Briefcase size={34} color="var(--color-accent)" strokeWidth={1.8} />
          </div>
          ...
          <p style={{ fontSize: '15px', color: 'var(--color-text-secondary)', lineHeight: 1.7, maxWidth: '300px', marginBottom: '10px', fontFamily: 'var(--font)' }}>
            Business resources to help you run your PT practice more efficiently.
          </p>
          ...
          <p style={{ fontSize: '13px', color: 'var(--color-text-secondary)', opacity: 0.7, lineHeight: 1.5, maxWidth: '260px', marginBottom: '28px', fontFamily: 'var(--font)' }}>
            Client onboarding, consultation tools, and business guides in one place.
          </p>
