...
const PLANNED_TEMPLATES = [
  { label: 'Beginner Strength', desc: 'A foundational 3-day programme for new clients.' },
  { label: 'Hypertrophy Block', desc: '4-day split targeting muscle growth across all major muscle groups.' },
  { label: 'Fat Loss Circuit', desc: 'High-intensity conditioning sessions for fat loss clients.' },
  { label: 'Mobility & Recovery', desc: 'Stretching and mobility routines for rehab or active recovery.' },
  { label: 'Client Assessment', desc: 'Standardised movement screens and strength benchmarks.' },
]

export default function ProgrammeTemplatesScreen() {
  const navigate = useNavigate()

  return (
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
      <Header title="Programme Templates" onBack={() => navigate(-1)} />
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '40px 20px 48px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: '36px' }}>
          <div style={{
            ...
            <Layout size={34} color="var(--color-accent)" strokeWidth={1.8} />
          </div>
          ...
          <p style={{ fontSize: '15px', color: 'var(--color-text-secondary)', lineHeight: 1.7, maxWidth: '300px', marginBottom: '10px', fontFamily: 'var(--font)' }}>
            Create and manage reusable training templates to assign to any client.
          </p>
          ...
          <p style={{ fontSize: '13px', color: 'var(--color-text-secondary)', opacity: 0.7, lineHeight: 1.5, maxWidth: '260px', marginBottom: '28px', fontFamily: 'var(--font)' }}>
            Templates you build will be available across all your clients and modes.
          </p>
